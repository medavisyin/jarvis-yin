...
- **Personal**: Donor Analysis, Daily Fetch (includes AI/World/China news fetch, commit report, Jira, Wiki Fetch, segmented audio)
...
- Generates per-segment narration via `qwen3:1.7b` (`OLLAMA_MODEL_NARRATION`)
