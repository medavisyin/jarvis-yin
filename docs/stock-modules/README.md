...
| `model_cross_sectional.py` | [model_cross_sectional.md](./model_cross_sectional.md) | 截面排序模型：XGBoost rank:pairwise 行业中性化选股，替代 scanner Layer 2 规则评分 |
...
config.py ─────────────────────────────────────────────── 所有模块的基础
  ...
  │
  ├── model_cross_sectional.py ─── scanner.py (Layer2 截面排序)
  │
...
| `model_cross_sectional.py` | [model_cross_sectional.md](./model_cross_sectional.md) | [ml-pipeline-impl.md](../implementation/stock/ml-pipeline-impl.md) | — |
...
| `right_side_scanner.py` | [right_side_scanner.md](./right_side_scanner.md) | [scanner-impl.md](../implementation/stock/scanner-impl.md) | — |
| `unified_scanner.py` | [unified_scanner.md](./unified_scanner.md) | [scanner-impl.md](../implementation/stock/scanner-impl.md) | — |
| `scan_cache.py` | [scan_cache.md](./scan_cache.md) | [scanner-impl.md](../implementation/stock/scanner-impl.md) | — |
