"""
Fetch recent Machine Learning papers from Arxiv cs.LG.

Replaces HuggingFace Trending Papers as a source for top ML research.
Arxiv is static HTML — loads fast with no JS wait needed.

Usage: python fetch-arxiv-ml.py [output-dir]
Output: <output-dir>/arxiv-ml.json
"""
import asyncio
import json
import os
